...
English lives next door, in `deutsch-worksheet/`, one tab-separated file per
catalog:
...
```sh
python3 tools/modkit.py validate deutsch --base imported
python3 tools/modkit.py translation deutsch --refresh   # pick up new engine strings
